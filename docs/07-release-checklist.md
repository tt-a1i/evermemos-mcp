# Release Checklist (Competition v0.4.6)

## 1) Goal
Ship a stable competition release (`v0.4.6`) and ensure all submission assets are complete and verifiable.
...
- [x] Update `pyproject.toml` version to `0.4.6`
...
```bash
git add .
git commit -m "release: prepare v0.4.6 competition package"
git tag v0.4.6
...
## 5) GitHub Release
- [x] Create GitHub release for `v0.4.6`
