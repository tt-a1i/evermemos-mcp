...
- [x] Phase 1: Release readiness (`v0.4.7`)
...
| --- | --- | --- | --- |
| Phase 1: Release readiness | Project maintainer | 2026-03-06 | `pyproject` bumped to `0.4.7`; `CHANGELOG.md` merged; release gates pass (`ruff`, `pytest`); tag `v0.4.7` pushed |
