...
- [x] Phase 1: Release readiness (`v0.5.5`)
...
| --- | --- | --- | --- |
| Phase 1: Release readiness | Project maintainer | 2026-03-06 | `pyproject` bumped to `0.5.0`; `CHANGELOG.md` merged; release gates pass (`ruff`, `pytest`); tag `v0.5.5` pushed |
...
- [x] Create and push git tag `v0.5.5`
